<?php 
	...
	$err_size=0;
	$edit=0;
	$statut_select = '<option value="Professionnel">Professionnel</option>
				  		<option value="Etudiant" selected>Étudiant</option>
				  		<option value="Autre">Autre</option>';
	$category = '<option value="pro">Professionnelle</option>
				  		<option value="stu" selected>Étudiante</option>
		...
		if($_GET['action']=="delete"){
			if(isset($_SESSION['login'])){
				...
				if(unlink ('media/images/upload/'.$new['image'])){
					...
					echo '<meta http-equiv="refresh" content="0;URL=etudiant#news">';
				}
				else{
...
<head>
	...
	<meta name="description" content="Vous voulez avoir une première expérience dans le milieu professionnel et valorisable sur votre CV, tout en étant rémunéré ? Découvrez la Junior Etude Montpellier Agro" />
	<title>JEMA - Junior Etude Montpellier Agro - Étudiant</title>
...
<body>
	...
	<div id="top" class="container-fluid">
		...
		<?php include_once('templates/student/student-navbar.php'); ?>
		<?php include_once('templates/student/header.php'); ?>

		<div class="main-content">

			<?php include_once('templates/student/about.html'); ?>
			<?php include_once('templates/numbers.html'); ?>
			<?php include_once('templates/edito.html'); ?>
			<?php include_once('templates/student/faq.html'); ?>
			<?php include_once('templates/student/member.html'); ?>
			<?php require_once('templates/student/news.php'); ?>
