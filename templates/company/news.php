<section id="news" class="news">
	...
	$count = $bdd->query("SELECT count(*) as total from news WHERE categorie LIKE '%pro%' OR categorie LIKE '%oth%'");
	$news = $bdd->query("SELECT * FROM news WHERE categorie LIKE '%pro%' OR categorie LIKE '%oth%' ORDER BY id DESC");
		...
		?>
	    	...
	    	<article class="news-content">
				...
				<ul class="actions">
					...
					?>
					<li>
						<a class="button-2" onclick="javascript:if(!confirm('Confirmer la suppression ?')){return false;}" href="professionnel-suppression-<?php echo $new['id']; ?>"><span class="glyphicon glyphicon-trash"></span></a>
					</li>
					<li>
	...
	<div class="news-publish" id="publish">
		...
		<form method="post" action="professionnel#publish" enctype="multipart/form-data">
